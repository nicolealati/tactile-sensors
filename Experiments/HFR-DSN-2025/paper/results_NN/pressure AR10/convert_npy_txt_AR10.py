...
pred_path = f"pressure ar10 {type} - pred.npy"
true_path = f"pressure ar10 {type} - true.npy"
...
# Save txt
np.savetxt(f"{type} ar10 pred_signal.txt", pred_signal)
np.savetxt(f"{type} ar10 pred_time.txt", pred_time)

np.savetxt(f"{type} ar10 true_signal.txt", true_signal)
np.savetxt(f"{type} ar10 true_time.txt", true_time)

np.savetxt(f"piezo ar10 signal.txt", piezo_signal)
np.savetxt(f"piezo ar10 time.txt", piezo_time)
