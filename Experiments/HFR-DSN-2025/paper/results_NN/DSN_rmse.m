...
figure('Position', [100, 100, 500, 300]); % [x, y, larghezza, altezza]
...
legend({'human finger', 'robotic finger'}, 'Location', 'northwestoutside', 'FontSize', size_legend, 'FontName', font)
