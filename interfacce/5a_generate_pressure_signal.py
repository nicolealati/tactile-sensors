...
# 1, 2, 3  = rise1, const1, fall1
SaveData(dir_trigger, 'trigger_rise_1.npy', trigger_list[1])
SaveData(dir_trigger, 'trigger_const_1.npy', trigger_list[2])
SaveData(dir_trigger, 'trigger_fall_1.npy', trigger_list[3])

# 4, 5, 6  = rise2, const2, fall2
SaveData(dir_trigger, 'trigger_rise_2.npy', trigger_list[4])
SaveData(dir_trigger, 'trigger_const_2.npy', trigger_list[5])
SaveData(dir_trigger, 'trigger_fall_2.npy', trigger_list[6])

# 7, 8, 9  = rise3, const3, fall3
