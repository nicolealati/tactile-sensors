...
class RollingAnimation:
    def __init__(self, excel_file, sheet_name):
        ...
        self.save_dir = r"D:\GitHub\tactile-sensors\SETUP\sensore-forza\data\trigger_rolling"
    ...
    def LoadPatterns(self): 
        ...
        self.angle_rot_1 = np.array(self.df_pattern['rotation_angle_1'].astype(int))/180*np.pi
        self.angle_rot_2 = np.array(self.df_pattern['rotation_angle_2'].astype(int))/180*np.pi
    ...
    def SaveData(self):
        ...
        np.save(self.save_dir + "/" + "trigger_orario_1.npy", self.trigger[5])
        np.save(self.save_dir + "/" + "trigger_antiorario_1.npy", self.trigger[6])
        np.save(self.save_dir + "/" + "trigger_orario_2.npy", self.trigger[7])
        np.save(self.save_dir + "/" + "trigger_antiorario_2.npy", self.trigger[8])
        np.save(self.save_dir + "/" + "x_interp.npy", self.x_interp)
        np.save(self.save_dir + "/" + "y_interp.npy", self.y_interp)
        np.save(self.save_dir + "/" + "angle_interp_1.npy", self.angle_interp_1)
        np.save(self.save_dir + "/" + "angle_interp_2.npy", self.angle_interp_2)
