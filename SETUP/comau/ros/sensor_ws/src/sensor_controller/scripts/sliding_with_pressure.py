...
class SlidingInterface:
    ...
    def SensorCallback(self, data):
        ...
        self.scaled_force = (self.applied_force-2)*self.rect[1]/0.25
    ...
    def LoadPatterns(self, df_pattern): 
        ...
        self.required_force = df_pattern['required_force']
        self.required_force = self.required_force[~np.isnan(self.required_force)]
        self.tolerance =df_pattern['tolerance']
    ...
    def UpdateFigure(self, frame):
        ...
        self.ax.set_title("SLIDING TASK")
        ...
        #self.trans_force = self.applied_force-self.required_force
...
if __name__ == '__main__':
    try: 
        sliding_interface = SlidingInterface(excel_file, test)
